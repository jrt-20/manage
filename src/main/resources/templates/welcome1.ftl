        ...
        <div class="layui-row layui-col-space15">
            <div class="layui-col-md8">
                <div class="layui-row layui-col-space15">
                                            ...
                                            <div class="panel layui-bg-number">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="panel-content">
                                                        <h1 class="no-margins">${peoplesNum}</h1>
                                                        <small>当前家庭成员数</small>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="layui-col-xs6">
                                            <div class="panel layui-bg-number">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="panel-content">
                                                        <h1 class="no-margins">${bankNums}</h1>
                                                        <small>当前账户数</small>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="layui-col-xs6">
                                            <div class="panel layui-bg-number">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="panel-content">
                                                        <h1 class="no-margins">${gupiaoNums}</h1>
                                                        <small>当前股票数量</small>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="layui-col-xs6">
                                            <div class="panel layui-bg-number">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="panel-content">
                                                        <h1 class="no-margins">${houseNums}</h1>
                                                        <small>当前房产总记录数</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="layui-col-md6">
                        <div class="layui-card">
                            <div class="layui-card-header"><i class="fa fa-credit-card icon icon-blue"></i>常用功能</div>
                            <div class="layui-card-body">
                                <div class="welcome-module">
                                    <div class="layui-row layui-col-space10 layuimini-qiuck">
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" data-content-href="/page/bank" data-title="菜单管理" data-icon="fa fa-window-maximize">
                                                <i class="fa fa-window-maximize"></i>
                                                <cite>银行管理</cite>
                                            </a>
                                        </div>
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" data-content-href="/page/gupiao" data-title="系统设置" data-icon="fa fa-gears">
                                                <i class="fa fa-gears"></i>
                                                <cite>股票管理</cite>
                                            </a>
                                        </div>
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" data-content-href="/page/table" data-title="表格示例" data-icon="fa fa-file-text">
                                                <i class="fa fa-file-text"></i>
                                                <cite>成员管理</cite>
                                            </a>
                                        </div>
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" data-content-href="/page/formStep" data-title="图标列表" data-icon="fa fa-dot-circle-o">
                                                <i class="fa fa-dot-circle-o"></i>
                                                <cite>收支记录</cite>
                                            </a>
                                        </div>
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" data-content-href="/page/house" data-title="表单示例" data-icon="fa fa-calendar">
                                                <i class="fa fa-calendar"></i>
                                                <cite>房产管理</cite>
                                            </a>
                                        </div>
<#--                                        <div class="layui-col-xs3 layuimini-qiuck-module">-->
<#--                                            <a href="javascript:;" data-content-href="#" data-title="按钮示例" data-icon="fa fa-snowflake-o">-->
<#--                                                <i class="fa fa-snowflake-o"></i>-->
<#--                                                <cite>按钮示例</cite>-->
<#--                                            </a>-->
<#--                                        </div>-->
<#--                                        <div class="layui-col-xs3 layuimini-qiuck-module">-->
<#--                                            <a href="javascript:;" data-content-href="#" data-title="弹出层" data-icon="fa fa-shield">-->
...
<#--                                        </div>-->
                    ...
                    <div class="layui-col-md12">
                        <div class="layui-card">
                            <div class="layui-card-header"><i class="fa fa-line-chart icon"></i>财产统计</div>
                            <div class="layui-card-body">
                                <div id="echarts-records" style="width: 80%;min-height:500px"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="layui-col-md4">
                ...
                <div class="layui-card">
                    <div class="layui-card-header"><i class="fa fa-fire icon"></i>信息概览</div>
                    <div class="layui-card-body layui-text">

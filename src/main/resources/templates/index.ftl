...
<head>
    <meta charset="utf-8">
    <title>layuimini-单页版 v1 - 基于Layui的后台管理系统前端模板</title>
    ...
    <div class="layui-header header">
        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item layuimini-setting">
                <a href="javascript:;">${users.username}</a>
                <dl class="layui-nav-child">
                    <dd>
                        <a href="javascript:;" data-content-href="/page/userSetting" data-title="基本资料" data-icon="fa fa-gears">基本资料</a>
                    </dd>
                    <dd>
                        <a href="javascript:;" data-content-href="/page/password"data-title="密码修改" data-icon="fa fa-gears">修改密码</a>
                    </dd>
                    <dd>
...
<script src="/layui/lib/layui-v2.5.5/layui.js?v=1.0.4" charset="utf-8"></script>
...
<script>
    layui.use(['element', 'layer', 'layuimini'], function () {
        ...
        // layuimini.init("/layui/api/init.json");
        layuimini.init("/init");

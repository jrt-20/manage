    ...
    <div class="layuimini-main">
        ...
        <script type="text/html" id="toolbarDemo">
            <div class="layui-btn-container">
                <button class="layui-btn layui-btn-sm data-add-btn"> 买入股票 </button>
            </div>
        </script>
    ...
    layui.use(['form', 'table','layuimini','element'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'gid', width: 140, title: '股票代码', sort: true},
                {field: 'gtype', width: 140, title: '股票类型'},
                {field: 'gvalue', width: 170, title: '股票份额'},
                {field: 'gup', title: '近7日涨幅', width: 170},
                {field: 'gupyear', title: '近1年涨幅', width: 170},
        ...
        $(".data-add-btn").on("click", function () {
            ...
            var content = layuimini.getHrefContent('/page/gupiao/add');

        ...
        <div class="layui-form login-form">
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="fname" lay-verify="required|password" placeholder="家庭名称" autocomplete="off" class="layui-input">
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    <label class="layui-icon layui-icon-password" for="password"></label>
                    <input type="text" name="mobile" lay-verify="required|password" placeholder="手机号" autocomplete="off" class="layui-input">
                </div>
                <div class="layui-form-item">
                    <label class="layui-icon layui-icon-password" for="password"></label>
                ...
                <div class="layui-form-item">
                    <button class="layui-btn layui-btn-fluid" lay-submit="" lay-filter="login">注册</button>
                </div>
            </form>
        </div>
    </div>
